...
public class AnimalFarm {
	...
	void animals() {
		String animal =JOptionPane.showInputDialog("what is your favorite animal if something does not happen when you saay it try agian with a new animal, no capitals!");
		...
		if (animal.contains("cat")||animal.contains("gato")) {
